...
export default function ReviewClient({ mistakes }: ReviewClientProps) {
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col">
            ...
            <main className="flex-1 max-w-2xl mx-auto w-full px-6 py-12 pb-40 flex flex-col">
            ...
            <AnimatePresence>
                {!isAnswered ? (
                    <div className="fixed bottom-0 left-0 right-0 border-t-2 border-border p-6 md:p-10 bg-background/80 backdrop-blur-md z-20">
                    ...
                    <motion.div
                        ...
                        animate={{ y: 0, opacity: 1 }}
                        className={cn(
                            "fixed bottom-0 left-0 right-0 p-8 border-t-2 z-20 backdrop-blur-xl",
                            isCorrect ? "bg-green-50/90 border-green-100 text-green-800" : "bg-red-50/90 border-red-100 text-red-800"
                        )}
                    >
