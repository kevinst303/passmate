...
export default function MockTestClient({ profile }: MockTestClientProps) {
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col">
            ...
            <main className="flex-1 max-w-3xl mx-auto w-full px-6 py-12 pb-48">
                <div className="mb-12">
            ...
            <AnimatePresence>
                {!isAnswered ? (
                    ...
                    <motion.div
                        ...
                        animate={{ y: 0 }}
                        className={cn(
                            "fixed bottom-0 left-0 right-0 p-6 md:p-10 border-t-2 z-20 backdrop-blur-xl",
                            isCorrect
                        ...
                        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div className="flex-1 text-center md:text-left">
                                ...
                                <div className={cn("font-medium", isCorrect ? "text-green-700 dark:text-green-500/80" : "text-red-700 dark:text-red-500/80")}>
                                    {!isCorrect && (
                                        <p className="block font-bold mb-1 underline underline-offset-4">
                                            {t("correctAnswer", { answer: currentQuestion.options[currentQuestion.correct_index] })}
                                        </p>
                                    )}
                            ...
                            <Button
                                size="lg"
                                className={cn(
                                    "w-full md:w-auto md:px-24 py-5 text-xl rounded-2xl",
