...
export default function SupportClient({ data }: SupportClientProps) {
    const categories = [
        { icon: BookOpen, title: "Study Guide", desc: "Learn how to use the app effectively.", color: "text-blue-500", bg: "bg-blue-50" },
        { icon: UserCheck, title: "Account & Billing", desc: "Manage your subscription and profile.", color: "text-green-500", bg: "bg-green-50" },
        { icon: Shield, title: "Test Information", desc: "Details about the official citizenship test.", color: "text-purple-500", bg: "bg-purple-50" },
        { icon: HeartHandshake, title: "Giving Feedback", desc: "Help us make PassMate even better.", color: "text-orange-500", bg: "bg-orange-50" }
    ];

    const faqs = [
        { q: "Is this app updated for 2025/2026?", a: "Yes, our content is constantly updated to reflect the latest version of 'Our Common Bond' and official test patterns." },
        { q: "How does the AI Tutor work?", a: "Our AI Tutor is trained on official Australian citizenship resources to answer your specific questions 24/7." },
        { q: "Can I use PassMate on multiple devices?", a: "Yes! Your progress syncs across desktop and mobile devices when you sign in." },
        { q: "What is your refund policy?", a: "We offer a 7-day no-questions-asked refund if you're not satisfied with Premium." }
    ];
            ...
            <main className="max-w-6xl mx-auto py-8 px-4">
                ...
                <section className="bg-white rounded-[4rem] border-2 border-border p-10 md:p-16 shadow-2xl relative overflow-hidden text-center mb-16">
                    ...
                    <div className="relative z-10 max-w-2xl mx-auto">
                        ...
                        <h1 className="text-4xl md:text-5xl font-display font-black mb-6">How can we help, mate?</h1>
                        <p className="text-xl text-muted-foreground font-bold mb-10">
                            Search our help center or browse categories below to find what you need.
                        </p>
                ...
                <div className="grid lg:grid-cols-2 gap-16">
                    ...
                    <section>
                        <h2 className="text-3xl font-display font-black mb-10 flex items-center gap-4">
                            <FileText className="w-8 h-8 text-primary" /> Frequently Asked
                        </h2>
                    ...
                    <div className="space-y-10">
                        ...
                        <section className="bg-black text-white rounded-[3.5rem] p-10 shadow-2xl relative overflow-hidden">
                            ...
                            <div className="relative z-10 text-center">
                                <h3 className="text-2xl font-display font-black mb-4">Still need help?</h3>
                                <p className="text-white/70 font-bold mb-8 leading-relaxed">
                                    Our friendly support team usually responds within 24 hours. Let's get you back to studying!
                                </p>
                                <div className="grid grid-cols-2 gap-4">
                                    <Link href="/contact" className="w-full">
                                        <Button className="w-full h-14 rounded-2xl font-black bg-white text-black hover:bg-white/90">
                                            <Mail className="w-5 h-5 mr-2" /> Message Us
                                        </Button>
                                    </Link>
                                ...
                                <div className="flex items-center justify-center gap-6 mt-8 text-xs font-black text-white/50 uppercase tracking-widest">
                                    <span className="flex items-center gap-2"><Clock className="w-3 h-3" /> Mon - Fri</span>
                                    <span className="flex items-center gap-2"><ExternalLink className="w-3 h-3" /> 24h Support</span>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="bg-white border-2 border-border rounded-[3rem] p-10 shadow-xl">
                            <h3 className="text-xl font-display font-black mb-8 flex items-center gap-3">
                                <PlayCircle className="w-5 h-5 text-red-500" /> Useful Resources
                            </h3>
                            <div className="space-y-4">
                                {[
                                    { label: "Official Resource Book (PDF)", href: "#" },
                                    { label: "Study Video Series", href: "#" },
                                    { label: "Community Forum", href: "#" },
                                    { label: "Booking Your Test", href: "#" }
                                ].map((res, i) => (
                                    <Link
                                        key={i}
                                        href={res.href}
