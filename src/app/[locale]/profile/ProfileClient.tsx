            ...
            <main className="max-w-5xl mx-auto py-8 space-y-10">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 text-muted-foreground font-bold italic mb-8">
                                ...
                                <div className="flex items-center gap-2">
                                    <User className="w-4 h-4" /> {t("joined", { date: joinedDate })}
                                </div>
                            </div>
                        ...
                        <section className="bg-card glass p-10 rounded-[3.5rem] border-2 border-border shadow-xl">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
                                <div className="text-center group">
                                    ...
                                    <p className="text-[10px] font-black text-muted-foreground uppercase">{t("currentXp")}</p>
                                ...
                                <div className="text-center group">
                                    ...
                                    <p className="text-[10px] font-black text-muted-foreground uppercase">{t("streak")}</p>
                                ...
                                <div className="text-center group">
                                    ...
                                    <p className="text-[10px] font-black text-muted-foreground uppercase">{t("quizzes")}</p>
                                ...
                                <div className="text-center group">
                                    ...
                                    <p className="text-[10px] font-black text-muted-foreground uppercase">{t("badges")}</p>
                        ...
                        <section className="bg-card glass p-10 rounded-[4.5rem] border-2 border-border shadow-xl">
                            ...
                            <div className="grid grid-cols-3 sm:grid-cols-4 gap-6">
                                {unlockedAchievements.slice(0, 8).map((achievement) => (
                                    ...
                                    >
                                        <div className="w-20 h-20 bg-gradient-to-br from-yellow-50 to-orange-50 border-4 border-white shadow-lg rounded-[2rem] flex items-center justify-center text-4xl relative overflow-hidden">
                ...
                <section className="bg-card glass rounded-[4rem] border-2 border-border shadow-xl overflow-hidden divide-y-2 divide-border/50">
                    {[
                        ...
                        { icon: Share2, label: tReferral("performance"), href: "/referral", color: "text-orange-500", bg: "bg-orange-50" },
                        { icon: MessageCircle, label: tSupport("title"), href: "/support", color: "text-purple-500", bg: "bg-purple-50" }
                    ].map((opt, i) => (
                        <Link
                            key={i}
                            href={opt.href}
